    ...
    <main className="min-h-screen overflow-hidden">
      ...
      <section className="mx-auto max-w-7xl px-6 py-14">
          ...
          <aside className="rounded-3xl border border-[#e5ddd4] bg-white/80 p-6 shadow-sm backdrop-blur-sm">
            ...
            <div className="mt-6 space-y-3">
              {careItems.map((item, i) => (
                <div key={item.label} className="group flex items-start gap-3 rounded-2xl bg-[#ece5dc]/80 px-4 py-3 transition-colors hover:bg-accent-soft/80">
        ...
        <div className="mt-8 grid animate-fade-in-up animate-delay-300 gap-6 md:grid-cols-4">
          {tips.map((t) => (
            <div key={t.title} className="rounded-3xl border border-[#e5ddd4] bg-white/80 p-6 shadow-sm backdrop-blur-sm transition-all hover:-translate-y-0.5 hover:border-accent hover:shadow-md">
