      ...
      <section className="relative mx-auto max-w-7xl px-6 py-14">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service, i) => (
            <article key={service.title} className="group animate-fade-in-up rounded-3xl border border-border bg-white/80 p-7 shadow-sm backdrop-blur-sm transition-all hover:-translate-y-1 hover:border-accent hover:shadow-xl hover:shadow-accent/10"
        ...
        <div className="mt-16 animate-fade-in-up animate-delay-300">
          <div className="relative overflow-hidden rounded-[2rem] border border-border bg-gradient-to-br from-white to-accent-soft/30 p-8 shadow-sm backdrop-blur-sm">
